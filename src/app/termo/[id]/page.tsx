  ...
  return (
    ...
    {!caso ? (
      ...
      <div className={styles.formWrapper}>
        ...
        <Row justify="start">
          <Col md={12} sm={24}>
            <span style={boldText}>Razão Social:</span> {caso.EmpresaRealizadoraFeira.Nome._text}
          </Col>
        </Row>
        <Row justify="start">
          <Col md={12} sm={24}>
            <span style={boldText}>Nome Fantasia:</span> {caso.EmpresaRealizadoraFeira.NomeFantasia._text}
          </Col>
          <Col md={12} sm={24}>
            <span style={boldText}>CNPJ:</span> {caso.EmpresaRealizadoraFeira.CNPJCPF._text}
          </Col>
        </Row>
        <Row justify="start">
          <Col md={12} sm={24}>
        ...
        <Row justify="start">
          ...
          <Col md={8} sm={24}>
            <span style={boldText}>UF:</span> {caso.EmpresaRealizadoraFeira.UF._text}
          </Col>
          <Col md={8} sm={24}>
            <span style={boldText}>CEP:</span> {caso.EmpresaRealizadoraFeira.CEP._text}
          </Col>
        </Row>
        <Row justify="start">
          <Col md={12} sm={24}>
        ...
        <Row justify="start">
          ...
          <Col md={12} sm={24}>
            <span style={boldText}>Bairro:</span> {caso.EmpresaRealizadoraFeira.Bairro._text}
          </Col>
        </Row>
        <Row justify="start">
          <Col md={8} sm={24}>
            <span style={boldText}>Cidade:</span> {caso.EmpresaRealizadoraFeira.Cidade._text}
          </Col>
          <Col md={8} sm={24}>
            <span style={boldText}>UF:</span> {caso.EmpresaRealizadoraFeira.UF._text}
          </Col>
        ...
        <Paragraph>
          ...
          participante do projeto/Atividade  - {caso.NomeFeiraEventoNegocio._text} - ),
          compromete-se a participar, na condição de expositor na Feira acima
          indicada em um espaço de {`área livre = R$ ${caso.ValorLocacaoAreaLivre._text} /m²  e área montada = R$ ${caso.ValorLocacaoAreaMontada._text} /m² `}
          a ser realizado no período de {convertToBRT(caso.DataInicio._text)} a {" "}
          {convertToBRT(caso.DataFim._text)}, Local {caso.Localidade._text}, no espaço adquirido
        ...
        <Paragraph>
          ...
          na feira com antecedência mínima de 30 dias, contados da data
