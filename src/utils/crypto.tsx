...
const CryptoExample = () => {
  ...
  const handleEncode = () => {
    const encoded = CryptoJS.enc.Base64.stringify(CryptoJS.enc.Utf8.parse(textToEncode));
    setEncodedText(encoded);
  };

  const handleDecode = () => {
    const decoded = CryptoJS.enc.Utf8.stringify(CryptoJS.enc.Base64.parse(encodedText));
