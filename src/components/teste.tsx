...
const XMLDisplay = () => {
            ...
            <tem:entitiesInfo>\
              <BizAgiWSParam>\
                <EntityData>\
                  ...
                  <Filters><![CDATA[CGCCFO_SEMMASCARA = ' + x + ']]></Filters>\
                </EntityData>\
              </BizAgiWSParam>\
            </tem:entitiesInfo>\
          </tem:getEntities>\
  ...
  return (
    <div>
      {xmlData ? (
        <pre>{JSON.stringify(xmlData["soap:Envelope"]["soap:Body"]["getEntitiesResponse"]["getEntitiesResult"]["BizAgiWSResponse"]["Entities"]["ClienteFornecedor"], null, 4)}</pre>
      ) : (
